...
func UpdateCasbinApi(oldPath string, newPath string, oldMethod string, newMethod string) error {
	sqlStr := "update casbin_rule set v1 = ?,v2 = ? where v1=? and v2=?"
	_,err := global.GVA_DB.Exec(sqlStr,newPath,newMethod,oldPath, oldMethod)
	return err
}
...
func Casbin() *casbin.Enforcer {
	...
	a, _ := sqladapter.NewAdapter(global.GVA_DB.DB, "mysql", "casbin_rule")
